...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      //mis rutas
      {
        path: "/apps/tipoactividad",
        name: "tipoactividad",
        component: () => import("@/views/apps/tipoactividad/TipoActividad.vue"),
        meta: {
          pageTitle: "Tipo de Actividad",
          breadcrumbs: ["Iglesia", "Tipo de Actividad"],
        },
      },
      {
        path: "/apps/horario",
        name: "horario",
        component: () => import("@/views/apps/horario/Horario.vue"),
        meta: {
          pageTitle: "Horarios",
          breadcrumbs: ["Iglesia", "Horarios"],
        },
      },
      {
        path: "/apps/iglesia",
        name: "iglesia",
        component: () => import("@/views/apps/iglesia/Iglesia.vue"),
        meta: {
          pageTitle: "Iglesias",
          breadcrumbs: ["Iglesia", "Iglesias"],
        },
      },
      {
        path: "/apps/ninos",
        name: "ninos",
        component: () => import("@/views/apps/persona/Nino.vue"),
        meta: {
          pageTitle: "Iglesias",
          breadcrumbs: ["Iglesia", "Niños"],
        },
      },
      {
        path: "/apps/personas-mayores",
        name: "personamayor",
        component: () => import("@/views/apps/persona/PersonaMayor.vue"),
        meta: {
          pageTitle: "Iglesias",
          breadcrumbs: ["Iglesia", "Mayores"],
        },
      },
      {
        path: "/apps/proyectos",
        name: "proyecto",
        component: () => import("@/views/apps/proyecto/Proyecto.vue"),
        meta: {
          pageTitle: "Iglesias",
          breadcrumbs: ["Iglesia", "Proyectos"],
        },
      },
      {
        path: "/apps/actividades",
        name: "actividad",
        component: () => import("@/views/apps/actividad/Actividad.vue"),
        meta: {
          pageTitle: "Iglesias",
          breadcrumbs: ["Iglesia", "Actividades"],
        },
      },
      {
        path: "/apps/ninos/ninos-details/:id",
        name: "apps-ninos-details",
        component: () => import("@/views/apps/persona/NinosDetails.vue"),
        meta: {
          pageTitle: "Detalles de Niños",
          breadcrumbs: ["Iglesia", "Niños"],
        },
      },
      {
        path: "/apps/proyectos/proyectos-details/:id",
        name: "apps-proyectos-details",
        component: () => import("@/views/apps/proyecto/ProyectoDetails.vue"),
        meta: {
          pageTitle: "Detalles de Niños",
          breadcrumbs: ["Iglesia", "Niños"],
        },
