    ...
    >
      ...
      >
        ...
        <router-link to="/" class="mb-0 mb-lg-12">
          <img
            alt="Logo"
            src="media/logos/logo-iglesia.jpeg"
        ...
        <div class="d-none d-lg-block text-white fs-base text-center">
          Las Hermanas Dominicas llevan en Marti más de 25 años de trabajo
          pastoral. Su labor principal es la educación y trabajo con los más
          necesitados, de ahí el trabajo que realizan con los niños de este
          pueblo en función de ofrecer una formación cristiana y en valores.
        </div>
        <!--end::Text-->
      </div>
      <!--end::Content-->
