const DocMenuConfig = [
  ...
  // },
  {
    ...
    pages: [
      ...
      // },
      {
        heading: "Tipo Actividad",
        route: "/apps/tipoactividad",
        svgIcon: "media/icons/duotune/ecommerce/ecm002.svg",
        fontIcon: "bi-chart",
      },
      {
  ...
  },
  {
    ...
    pages: [
      ...
      {
        heading: "Personas Mayores",
        route: "/apps/personas-mayores",
        svgIcon: "media/icons/duotune/communication/com012.svg",
        fontIcon: "bi-chat-left",
      },
    ],
  },
  {
    ...
    pages: [
      {
        heading: "Proyectos",
        route: "/apps/proyectos",
        svgIcon: "media/icons/duotune/general/gen014.svg",
        fontIcon: "bi-calendar3-event",
      },
      {
        heading: "Actividades",
        route: "/apps/actividades",
        svgIcon: "media/icons/duotune/communication/com012.svg",
        fontIcon: "bi-chat-left",
      },
    ],
