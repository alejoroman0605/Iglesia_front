  ...
  <div :class="widgetClasses" class="card">
    ...
    <div class="card-header border-0 py-5">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bold fs-3 mb-1">Estadísticas</span>

        <span class="text-muted fw-semobold fs-7"
          >Niños: ({{ varones + hembras }})</span
        >
      </h3>
    ...
    <div class="card-body p-0 d-flex flex-column">
      ...
      <div class="card-p pt-5 bg-body flex-grow-1">
        ...
        <div class="row g-0">
          ...
          <div class="col mr-8">
            <!--begin::Label-->
            <div class="fs-7 text-muted fw-semobold">Proyectos</div>
            <!--end::Label-->

            <!--begin::Stat-->
            <div class="d-flex align-items-center">
              <div class="fs-4 fw-bold">{{ proyectos }}</div>
          ...
          <div class="col">
            <!--begin::Label-->
            <div class="fs-7 text-muted fw-semobold">Actividades</div>
            <!--end::Label-->

            <!--begin::Stat-->
            <div class="d-flex align-items-center">
              <div class="fs-4 fw-bold">{{ actividades }}</div>
        ...
        <div class="row g-0 mt-8">
          ...
          <div class="col mr-8">
            <!--begin::Label-->
            <div class="fs-7 text-muted fw-semobold">Varones</div>
            <!--end::Label-->

            <!--begin::Stat-->
            <div class="fs-4 fw-bold">{{ varones }} ({{ pVarones }}%)</div>
            <!--end::Stat-->
          </div>
          <!--end::Col-->
          ...
          <div class="col">
            <!--begin::Label-->
            <div class="fs-7 text-muted fw-semobold">Hembras</div>
            <!--end::Label-->

            <!--begin::Stat-->
            <div class="d-flex align-items-center">
              <div class="fs-4 fw-bold">{{ hembras }} ({{ pHembras }}%)</div>
            </div>
            <!--end::Stat-->
          </div>
          <!--end::Col-->
